...
namespace CitizenMatt.ReSharper.Nancy
{
    ...
    {
        private static readonly AssemblyNameInfo NancyViewEnginesRazor = new AssemblyNameInfo("Nancy.ViewEngines.Razor");
        ...
        {
            if (IsReferencingNancyRazor(projectFile))
